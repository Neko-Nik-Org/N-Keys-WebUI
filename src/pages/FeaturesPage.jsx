...
const features = [
  {
    ...
    description: 'Store sensitive variables in encrypted, centralized project vaults.',
    iconPath: 'M12 3L5 7v5c0 5 3.5 8 7 9 3.5-1 7-4 7-9V7l-7-4z',
  },
  {
    title: 'Simple API access',
    description: 'Fetch environment values programmatically with straightforward endpoints.',
    iconPath: 'M8 9l-3 3 3 3M16 9l3 3-3 3M13 7l-2 10',
  },
  {
    title: 'Team environments',
    description: 'Separate development, staging, and production variables with clean controls.',
  ...
  },
  {
    ...
    description: 'Inject secrets into container workflows without manual copy-paste steps.',
    iconPath: 'M4 13h16M8 9V6h4v3M9 17h6M6 13v4h12v-4',
  },
  {
    title: 'Audit logs',
    description: 'Track updates to secrets with concise and readable change history.',
    iconPath: 'M6 4h12v16H6zM9 8h6M9 12h6M9 16h4',
  },
  {
    title: 'Fast onboarding',
    description: 'Invite teammates and standardize project configs from day one.',
